...
const teamMembersArabic = [
    ...
    {
        name: 'بناء الطرق',
        major: 'نقدم خدمات شاملة لصيانة الطرق، بالإضافة إلى أعمال البنية التحتية والأعمال الكهربائية مثل الإضاءة ومحطات توليد الطاقة والمحولات ووسائل الاتصال والتحكم وغيرها.',
    ...
    return (
        <div style={{ paddingTop: '20px', backgroundColor: '#fafafa' }}>
            <div className={styles.text}>
                ...
                <p className={styles.titlep}>من ناحية أخرى، ننكر بغضب صادق ونكره الرجال الذين تُضلّ وتفسد أعمالهم بفعل السحر والمغريات للحظة، والذين يُعمّى عقلهم بالرغبة</p>
            </div>
