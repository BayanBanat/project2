                        ...
                        <div className={`${styles.row}  pb--100`}>
                            <div className="col-md-12">
                                <div className={styles.htc__contact__inner}>
                                    ...
                                    <p className={styles.htc__contact__innerp}>On the other hand, we denounce with righteous indignation and dislike men who are so beguiled demoralized On the er hand, we denounce with pain and trouble that are bound to ensue; and equal blame belongs to those </p>
                                </div>
                                <div className={styles.htc__address__container}>
                                    <div className={styles.ct__address}>
                                        ...
                                        <div className="ct__details">
                                            <p>Riyadh, Saudi Arabia <br></br> 1st Lane, San Francisco, USA</p>
                                        </div>
                                    </div>
