                        ...
                        <div className={`${styles.row}  pb--100`}>
                            <div className="col-md-12">
                                <div className={styles.htc__contact__inner}>
                                    ...
                                    <p className={styles.htc__contact__innerp}>من ناحية أخرى، ندين بالاستياء الصادق ونكره الرجال الذين يتسللون بهوى اللحظة وينحدرون بسحر متعة اللحظة، معتمدين على الرغبة</p>
                                </div>
                                <div className={styles.htc__address__container}>
                                    <div className={styles.ct__address}>
                                        ...
                                        <div className="ct__details">
                                            <p>الرياض، المملكة العربية السعودية <br></br> الشارع الأول، سان فرانسيسكو، الولايات المتحدة</p>
                                        </div>
                                    </div>
